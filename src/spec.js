...
var checkCreator = require("./index.js");
var check;
...
describe("invalid dependencies", function() {
	it("throws error if invalid ko object is given", function() {
		expect(function() {
			checkCreator({
				ko: "not really an object"
			});
		}).toThrowError("Invalid 'ko' parameter given!");

		expect(function() {
			checkCreator({
				ko: {
					isObservable: "not really a function"
				}
			});
		}).toThrowError("Invalid 'ko' parameter given!");
	});
...
describe("valid dependencies - with ko", function() {	
	beforeEach(function() {
		check = checkCreator({
			ko: ko
		});		
	...
	describe("test the parameters given", function() {
		...
		it ("uses the correct name in the error message if the item to check is not an object", function() {
			expect(function() {
				check("ugly, evil string", {}, "My favourite parameter");
			}).toThrowError("My favourite parameter has to be an object!");
		});
	});
